...
const Team = () => {
    ...
    return (
        <div className={teamStyles.container}>
            ...
            <h3>Want to join our team? Join the <a href='https://hackclub.slack.com/archives/C029KLH2UCU' target="_blank">Slack channel</a> and find something to help with!</h3>
