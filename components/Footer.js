...
const Footer = () => {
    return (
        <div className={footerStyles.container}>
          ...
          <Image height={75} width={75} alt={`${member.name}'s profile picture`} src={`https://www.stickermule.com/about/_next/static/public/logoColored.67e93281fc7b7837ca6c47a44ff7ea56.svg`} className={teamStyles.teamPFP} />
